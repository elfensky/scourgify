...
This is where Phase 5 attaches undo — the row table lives in its own method so a retry/undo
button row can be appended later without touching the rest of the dialog."""
from qt.core import QDialog, QLabel, QPushButton, QTableWidget, QTableWidgetItem, Qt, QVBoxLayout
